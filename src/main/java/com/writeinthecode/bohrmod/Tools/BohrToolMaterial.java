...
public class BohrToolMaterial {

    public static final IItemTier bohr = new ToolMaterial(3, Config.durabilitiy_bohr.get(),
        9.5F, Config.attackdamage_bohr.get(), 10, () -> Ingredient.fromItems(RegisterItems.bohr));
    ...
    private static class ToolMaterial implements IItemTier{
        ...
        public ToolMaterial(int harvestLevel, int maxUses, float efficiency, double attackDamage,
                            int enchantability, Supplier<Ingredient> supplier) {
